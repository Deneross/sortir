 ...
 */
final class Version20260303142443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD cancel TINYINT DEFAULT 0 NOT NULL, ADD archived TINYINT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP cancel, DROP archived');
