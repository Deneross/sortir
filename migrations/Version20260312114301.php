 ...
 */
final class Version20260312114301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lieu ADD latitude VARCHAR(20) DEFAULT NULL, ADD longitude VARCHAR(20) DEFAULT NULL');
